...
class Solution:
    ...
    # 48ms, 13.6MB
    @staticmethod
    def smaller_numbers_than_current_v2(nums: List[int]) -> List[int]:
...
if __name__ == '__main__':
    ...
    for tc in test_cases:
        print(Solution.smaller_numbers_than_current(tc))
        print(Solution.smaller_numbers_than_current_v2(tc))
