"""
  @Author       : liujianhan
  @Date         : 2020/4/3 上午9:19
  @Project      : leetcode_in_python
  @FileName     : 8.字符串转换整数atoi(M).py
...
class Solution:
    ...
    # 40ms, 13.4MB
    @classmethod
    def my_atoi_v2(cls, str: str) -> int:
        target_pattern = re.compile(r'^[\+\-]?\d+')
        target_number = int(*target_pattern.findall(str.lstrip()))

        return max(min(target_number, INT_MAX), INT_MIN)
